...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7e3dbe1f5122749d37d4068b26ea9a7fc65c4eaf71f490ff5aedd100dabb4f9f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "3/Apr/2025";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040371555b613754deba9157894bdd2a34102872f5ceba2371374f2ef0c5c6c83714226f5a49184eca81331fa99ea1227b79d7eeb78e628a36d80b2e229c110dd5") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1743710290;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085991394;

        if (fTestNet)
        {
            block.nTime    = 1743710278;
            block.nNonce   = 386423224;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xe55ca36044f156a34573674bf6f3ba4732830543e3bd4693f9efe69e72c7500c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb5, 0xde }; // Palcoin: increase each by adding 2 to bitcoin's value.
